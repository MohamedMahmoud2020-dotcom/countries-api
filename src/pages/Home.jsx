  ...
  return (
    <div className='px-14 py-12'>
        <div className='flex justify-between mb-8'>
            <div className='flex p-4 bg-white w-4/12 rounded-md' style={props.clicked ? {backgroundColor:"#2b3743", color:"white"} : {backgroundColor:"#ffff"}}>
            ...
            <select onChange={getValue} name="" id="" className='w-1/6 rounded-md outline-none z-1' placeholder='Filter by Region' style={props.clicked ? {backgroundColor:"#2b3743", color:"white"} : {backgroundColor:"#ffff"}}>
        ...
        <div className='grid grid-cols-4 gap-y-16 gap-x-24'>
